...
//        // Determine the grade level of the student based on numberOfCredits
    ...
    public String toString() {
       String studentReport = String.format("% is a %s with %d credits and a GPA of %.2f", this.name, this.getGradeLevel(this.numberOfCredits), this.getNumberOfCredits(), this.getGpa());
